...
public class BookTicket
{
    ...
    public static void book(Flight currentFlight, int tickets,int passengerID, String cls)
    {
       ...
       if(cls.equalsIgnoreCase("Business")){
           passengerDetail = "Passenger ID " + passengerID + " -- " + " Number of Tickets Booked " 
                            + tickets + " -- " + "Total cost " + currentFlight.Businessprice * tickets;
       }
       else if(cls.equalsIgnoreCase("Economic")){
        passengerDetail = "Passenger ID " + passengerID + " -- " + " Number of Tickets Booked " 
        + tickets + " -- " + "Total cost " + currentFlight.Ecoprice * tickets;
       }
       else{
           System.out.println("No such class is avaliable");
           System.exit(0);
       }
       
       //add passenger detail to flight object
       currentFlight.addPassengerDetails(passengerDetail,tickets,passengerID,cls);
    ...
    public static void cancel(Flight currentFlight, int passengerID,String cls)
    {
        // calling cancel function on the flight object
        currentFlight.cancelTicket(passengerID,cls);
        currentFlight.flightSummary();
        currentFlight.printDetails();
    }
    ...
    public static void main(String[] args)
    {
        ...
        switch(choice)
        {
            ...
            case 1:
            {
                System.out.print("Enter the class Business or Economic: ");
                String cls = sc.next();
                ...
                if(t > currentFlight.Businesstickets && cls.equalsIgnoreCase("Business"))
                {
                    System.out.println("Not Enough Business Tickets");
                    break;
                }
                else if(t > currentFlight.Ecotickets && cls.equalsIgnoreCase("Economic")){
                    System.out.println("Not Enough Business Tickets");
                    break;
                }
                // call book function to book tickets
                book(currentFlight,t,passengerID,cls);
            ...
            case 2:
            {
                ...
                int fid = sc.nextInt();
                System.out.print("Enter your class: 1.Business 2.Economic:");
                String cls1 = sc.next();
                //check if flight id is valid
                if(fid > flights.size())
                {
            ...
            case 3:
            {
                ...
                for(Flight f : flights)
                {
                        ...
                        if(f.BusinesspassengerDetails.size() == 0 && f.EcopassengerDetails.size()==0)
                        {
